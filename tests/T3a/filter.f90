...
do k=1,n 
   ...
   do j=k+1,l 
      ...
      i=j 
   enddo
   if (dum==0._mytype) aff(k)=0._mytype 
   if (i/=k) then 
      dum=aff(k) 
      aff(k)=aff(i) 
      aff(i)=dum 
...
fialx=0.45_mytype 
fibex=(3._mytype - 2._mytype*fialx)/10._mytype 
fiaix=(2._mytype + 3._mytype*fialx)/4._mytype 
fibix=(6._mytype + 7._mytype*fialx)/8._mytype 
ficix=(6._mytype + fialx)/20._mytype 
fidix=(2._mytype - 3._mytype*fialx)/40._mytype 
fibix=fibix*0.5_mytype 
ficix=ficix*0.5_mytype 
fidix=fidix*0.5_mytype 
fialy=0.45_mytype 
fibey=(3._mytype - 2._mytype*fialy)/10._mytype 
fiaiy=(2._mytype + 3._mytype*fialy)/4._mytype 
fibiy=(6._mytype + 7._mytype*fialy)/8._mytype 
ficiy=(6._mytype + fialy)/20._mytype 
fidiy=(2._mytype - 3._mytype*fialy)/40._mytype 
fibiy=fibiy*0.5_mytype 
ficiy=ficiy*0.5_mytype 
fidiy=fidiy*0.5_mytype 
fialz=0.45_mytype 
fibez=(3._mytype - 2._mytype*fialz)/10._mytype 
fiaiz=(2._mytype + 3._mytype*fialz)/4._mytype 
fibiz=(6._mytype + 7._mytype*fialz)/8._mytype 
ficiz=(6._mytype + fialz)/20._mytype 
fidiz=(2._mytype - 3._mytype*fialz)/40._mytype 
fibiz=fibiz*0.5_mytype 
ficiz=ficiz*0.5_mytype 
fidiz=fidiz*0.5_mytype 
fia1x=15._mytype/16._mytype 
fib1x=1._mytype/4._mytype 
fic1x=-3._mytype/8._mytype 
fid1x=1._mytype/4._mytype 
fie1x=-1._mytype/16._mytype 

fia1y=15._mytype/16._mytype 
fib1y=1._mytype/4._mytype 
fic1y=-3._mytype/8._mytype 
fid1y=1._mytype/4._mytype 
fie1y=-1._mytype/16._mytype 

fia1z=15._mytype/16._mytype 
fib1z=1._mytype/4._mytype 
fic1z=-3._mytype/8._mytype 
fid1z=1._mytype/4._mytype 
fie1z=-1._mytype/16._mytype 

fia2x=3._mytype/4._mytype 
fib2x=1._mytype/16._mytype 
fic2x=3._mytype/8._mytype 
fid2x=-1._mytype/4._mytype 
fie2x=1._mytype/16._mytype 

fia2y=3._mytype/4._mytype 
fib2y=1._mytype/16._mytype 
fic2y=3._mytype/8._mytype 
fid2y=-1._mytype/4._mytype 
fie2y=1._mytype/16._mytype 

fia2z=3._mytype/4._mytype 
fib2z=1._mytype/16._mytype 
fic2z=3._mytype/8._mytype 
fid2z=-1._mytype/4._mytype 
fie2z=1._mytype/16._mytype 

fia3x=5._mytype/8._mytype 
fib3x=-1._mytype/16._mytype 
fic3x=1._mytype/4._mytype 
fid3x=4._mytype/16._mytype 
fie3x=-1._mytype/16._mytype 

fia3y=5._mytype/8._mytype 
fib3y=-1._mytype/16._mytype 
fic3y=1._mytype/4._mytype 
fid3y=4._mytype/16._mytype 
fie3y=-1._mytype/16._mytype 

fia3z=5._mytype/8._mytype 
fib3z=-1._mytype/16._mytype 
fic3z=1._mytype/4._mytype 
fid3z=4._mytype/16._mytype 
fie3z=-1._mytype/16._mytype 
...
enddo
xdet=(1._mytype-fibex*fiz1x(1)+fiz1x(nx-1)*fibex/xcoef+&
     fialx*fiz1x(nx)/xcoef)*&
     (1._mytype+fialx*fiz2x(1)/xcoef+fibex*fiz2x(2)/xcoef-&
     fibex*fiz2x(nx))-&
...
enddo
ydet=(1._mytype-fibey*fiz1y(1)+fibey*fiz1y(ny-1)/xcoef+&
     fialy*fiz1y(ny)/xcoef)*&
     (1._mytype+fialy*fiz2y(1)/xcoef+fibey*fiz2y(2)/xcoef-&
     fibey*fiz2y(ny))-&
...
enddo
zdet=(1._mytype-fibez*fiz1z(1)+fiz1z(nz-1)*fibez/xcoef+&
     fialz*fiz1z(nz)/xcoef)*&
     (1._mytype+fialz*fiz2z(1)/xcoef+fibez*fiz2z(2)/xcoef-&
     fibez*fiz2z(nz))-&
