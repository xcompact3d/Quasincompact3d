...
!!! CM    write(*,*) 'In poisson_11x',nclz1

!!! CM call test_min_max('rhs  ','In main deco   ',rhs,size(rhs))
...
xkx(:)=0._mytype ; xk2(:)=0._mytype ; yky(:)=0._mytype ; yk2(:)=0._mytype
zkz(:)=0._mytype ; zk2(:)=0._mytype

!WAVE NUMBER IN X
if (nclx==0) then
   do i=1,nx/2+1
      w=2._mytype*pi*(i-1)/nx
      wp=acix6*2._mytype*dx*sin(w/2._mytype)+(bcix6*2._mytype*dx)*sin(3._mytype/2._mytype*w)
      wp=wp/(1._mytype+2._mytype*alcaix6*cos(w))
   ...
   do i=1,nx
      w=2._mytype*pi*0.5_mytype*(i-1)/nxm
      wp=acix6*2._mytype*dx*sin(w/2._mytype)+(bcix6*2._mytype*dx)*sin(3._mytype/2._mytype*w)
      wp=wp/(1._mytype+2._mytype*alcaix6*cos(w))
...
if (ncly==0) then
   do j=1,ny/2+1
      w=2._mytype*pi*(j-1)/ny
      wp=aciy6*2._mytype*dy*sin(w/2._mytype)+(bciy6*2._mytype*dy)*sin(3._mytype/2._mytype*w)
      wp=wp/(1._mytype+2._mytype*alcaiy6*cos(w))
   ...
   do j=1,ny
      w=2._mytype*pi*0.5_mytype*(j-1)/nym
      wp=aciy6*2._mytype*dy*sin(w/2._mytype)+(bciy6*2._mytype*dy)*sin(3._mytype/2._mytype*w)
      wp=wp/(1._mytype+2._mytype*alcaiy6*cos(w))
...
if (nclz==0) then
   do k=1,nz/2+1
      w=2._mytype*pi*(k-1)/nz
      wp=aciz6*2._mytype*dz*sin(w/2._mytype)+(bciz6*2._mytype*dz)*sin(3._mytype/2._mytype*w)
      wp=wp/(1._mytype+2._mytype*alcaiz6*cos(w))
   ...
   do k=1,nz/2+1
      w=2._mytype*pi*0.5_mytype*(k-1)/nzm
      w1=2._mytype*pi*0.5_mytype*(nzm-k+1)/nzm
      wp=aciz6*2._mytype*dz*sin(w/2._mytype)+(bciz6*2._mytype*dz)*sin(3._mytype/2._mytype*w)
      wp=wp/(1._mytype+2._mytype*alcaiz6*cos(w))
      w1p=aciz6*2._mytype*dz*sin(w1/2._mytype)+(bciz6*2._mytype*dz)*sin(3._mytype/2._mytype*w1)
      w1p=w1p/(1._mytype+2._mytype*alcaiz6*cos(w1))     
...
do j = sp%yst(2), sp%yen(2)
do i = sp%yst(1), sp%yen(1)
   xtt=cmplx((bicix6*2._mytype*cos(real(exs(i))*3._mytype*dx/2._mytype)+&
        cicix6*2._mytype*cos(real(exs(i), kind=mytype)*5._mytype*dx/2._mytype)),&
        (bicix6*2._mytype*cos(real(exs(i), kind=mytype)*3._mytype*dx/2._mytype)+&
        cicix6*2._mytype*cos(real(exs(i), kind=mytype)*5._mytype*dx/2._mytype)), kind=mytype)
   ytt=cmplx((biciy6*2._mytype*cos(real(eys(j), kind=mytype)*3._mytype*dy/2._mytype)+&
        ciciy6*2._mytype*cos(real(eys(j), kind=mytype)*5._mytype*dy/2._mytype)),&
        (biciy6*2._mytype*cos(real(eys(j), kind=mytype)*3._mytype*dy/2._mytype)+&
        ciciy6*2._mytype*cos(real(eys(j), kind=mytype)*5._mytype*dy/2._mytype)), kind=mytype)
   ztt=cmplx((biciz6*2._mytype*cos(real(ezs(k), kind=mytype)*3._mytype*dz/2._mytype)+&
        ciciz6*2._mytype*cos(real(ezs(k), kind=mytype)*5._mytype*dz/2._mytype)),&
        (biciz6*2._mytype*cos(real(ezs(k), kind=mytype)*3._mytype*dz/2._mytype)+&
        ciciz6*2._mytype*cos(real(ezs(k), kind=mytype)*5._mytype*dz/2._mytype)), kind=mytype)
   xtt1=cmplx((aicix6*2._mytype*cos(real(exs(i), kind=mytype)*dx/2._mytype)),&
        (aicix6*2._mytype*cos(real(exs(i), kind=mytype)*dx/2._mytype)), kind=mytype)
   ytt1=cmplx((aiciy6*2._mytype*cos(real(eys(j), kind=mytype)*dy/2._mytype)),&
        (aiciy6*2._mytype*cos(real(eys(j), kind=mytype)*dy/2._mytype)), kind=mytype)
   ztt1=cmplx((aiciz6*2._mytype*cos(real(ezs(k), kind=mytype)*dz/2._mytype)),&
        (aiciz6*2._mytype*cos(real(ezs(k), kind=mytype)*dz/2._mytype)), kind=mytype)
   xt1=cmplx((1._mytype+2._mytype*ailcaix6*cos(real(exs(i), kind=mytype)*dx)),&
        (1._mytype+2._mytype*ailcaix6*cos(real(exs(i), kind=mytype)*dx)), kind=mytype)
   yt1=cmplx((1._mytype+2._mytype*ailcaiy6*cos(real(eys(j), kind=mytype)*dy)),&
        (1._mytype+2._mytype*ailcaiy6*cos(real(eys(j), kind=mytype)*dy)), kind=mytype)
   zt1=cmplx((1._mytype+2._mytype*ailcaiz6*cos(real(ezs(k), kind=mytype)*dz)),&
        (1._mytype+2._mytype*ailcaiz6*cos(real(ezs(k), kind=mytype)*dz)), kind=mytype)
...
enddo
   ...
   if (nclz==0) then
      ...
      do j = sp%xst(2),sp%xen(2)
      do i = sp%xst(1),sp%xen(1)
         xtt=cmplx((bicix6*2._mytype*cos(real(exs(i), kind=mytype)*3._mytype*dx/2._mytype)+&
              cicix6*2._mytype*cos(real(exs(i), kind=mytype)*5._mytype*dx/2._mytype)),&
              (bicix6*2._mytype*cos(real(exs(i), kind=mytype)*3._mytype*dx/2._mytype)+&
              cicix6*2._mytype*cos(real(exs(i), kind=mytype)*5._mytype*dx/2._mytype)), kind=mytype)
         ytt=cmplx((biciy6*2._mytype*cos(real(eys(j), kind=mytype)*3._mytype*dy/2._mytype)+&
         ...
         ztt1=cmplx((aiciz6*2._mytype*cos(real(ezs(k), kind=mytype)*dz/2._mytype)),&
              (aiciz6*2._mytype*cos(real(ezs(k), kind=mytype)*dz/2._mytype)), kind=mytype)
         xt1=cmplx((1._mytype+2._mytype*ailcaix6*cos(real(exs(i), kind=mytype)*dx)),&
              (1._mytype+2._mytype*ailcaix6*cos(real(exs(i))*dx)), kind=mytype)
         yt1=cmplx((1._mytype+2._mytype*ailcaiy6*cos(real(eys(j), kind=mytype)*dy)),&
              (1._mytype+2._mytype*ailcaiy6*cos(real(eys(j), kind=mytype)*dy)), kind=mytype)
         zt1=cmplx((1._mytype+2._mytype*ailcaiz6*cos(real(ezs(k), kind=mytype)*dz)),&
              (1._mytype+2._mytype*ailcaiz6*cos(real(ezs(k), kind=mytype)*dz)), kind=mytype)
...
!   print *,i,j,k, kxyz(i,j,k)
      ...
      do i = sp%xst(1),sp%xen(1)  
         ...
         ztt=cmplx((biciz6*2._mytype*cos(real(ezs(k), kind=mytype)*3._mytype*dz/2._mytype)+&
              ciciz6*2._mytype*cos(real(ezs(k), kind=mytype)*5._mytype*dz/2._mytype)),&
              (biciz6*2._mytype*cos(aimag(ezs(k))*3._mytype*dz/2._mytype)+&
              ciciz6*2._mytype*cos(aimag(ezs(k))*5._mytype*dz/2._mytype)), kind=mytype)
         !
         xtt1=cmplx((aicix6*2._mytype*cos(real(exs(i), kind=mytype)*dx/2._mytype)),&
              (aicix6*2._mytype*cos(real(exs(i), kind=mytype)*dx/2._mytype)), kind=mytype)
         ytt1=cmplx((aiciy6*2._mytype*cos(real(eys(j), kind=mytype)*dy/2._mytype)),&
         ...
         !
         ztt1=cmplx((aiciz6*2._mytype*cos(real(ezs(k), kind=mytype)*dz/2._mytype)),&
              (aiciz6*2._mytype*cos(aimag(ezs(k))*dz/2._mytype)), kind=mytype)
         !
         xt1=cmplx((1._mytype+2._mytype*ailcaix6*cos(real(exs(i), kind=mytype)*dx)),&
              (1._mytype+2._mytype*ailcaix6*cos(real(exs(i), kind=mytype)*dx)), kind=mytype)
         yt1=cmplx((1._mytype+2._mytype*ailcaiy6*cos(real(eys(j), kind=mytype)*dy)),&
              (1._mytype+2._mytype*ailcaiy6*cos(real(eys(j), kind=mytype)*dy)), kind=mytype)
         zt1=cmplx((1._mytype+2._mytype*ailcaiz6*cos(real(ezs(k), kind=mytype)*dz)),&
              (1._mytype+2._mytype*ailcaiz6*cos(aimag(ezs(k))*dz)), kind=mytype)
...
if ((istret==1).or.(istret==2)) then
   ...
   xa0=alpha/pi+1._mytype/2._mytype/beta/pi
   if (istret==1) xa1=1._mytype/4._mytype/beta/pi
   if (istret==2) xa1=-1._mytype/4._mytype/beta/pi
!
...
!sup diag +1
   ...
   enddo
   do i=sp%yst(1),sp%yen(1)   
      a(i,1,k,4)=2._mytype*cmplx((xa0*xa1*(real(cw22(i,1,k), kind=mytype)*real(cw22(i,2,k), kind=mytype)+&
           real(cw22(i,2,k), kind=mytype)*&
           real(cw22(i,2,k), kind=mytype))),&
...
!sup diag +2
   ...
   enddo
   a(i,1,k,5)=cmplx(real(a(i,1,k,5), kind=mytype)*2._mytype,aimag(a(i,1,k,5))*2._mytype, kind=mytype)
   a(i,ny/2-1,k,5)=0._mytype
   a(i,ny/2,k,5)=0._mytype
   a2(i,ny/2-1,k,5)=0._mytype
   a2(i,ny/2,k,5)=0._mytype 
   enddo
   enddo
...
!inf diag -2
   ...
   a(i,1,k,1)=0._mytype
   a(i,2,k,1)=0._mytype
   a2(i,1,k,1)=0._mytype
   a2(i,2,k,1)=0._mytype
   enddo
   enddo
!not to have a singular matrice
   do k=sp%yst(3),sp%yen(3)
   do i=sp%yst(1),sp%yen(1)
      if ((real(xk2(i), kind=mytype)==0._mytype).and.(real(zk2(k), kind=mytype)==0)) then
         a(i,1,k,3)=cmplx(1._mytype,1._mytype, kind=mytype)
         a(i,1,k,4)=0._mytype
         a(i,1,k,5)=0._mytype
      endif
   enddo
   ...
   xa0=alpha/pi+1._mytype/2._mytype/beta/pi
   xa1=-1._mytype/4._mytype/beta/pi 
!
!construction of the pentadiagonal matrice
!   
   do k=sp%yst(3),sp%yen(3)
...
!sup diag +2
   ...
   !a3(i,1,k,5)=0.
   a3(i,nym-1,k,5)=0._mytype
   a3(i,nym,k,5)=0._mytype
   enddo
   enddo
...
!inf diag -2
   ...
   do j=3,nym
      a3(i,j,k,1)=cmplx(-real(cw22(i,j-1,k), kind=mytype)*real(cw22(i,j-2,k), kind=mytype)*xa1*xa1,&
           -aimag(cw22(i,j-1,k))*aimag(cw22(i,j-2,k))*xa1*xa1, kind=mytype)
   enddo
   a3(i,1,k,1)=0._mytype
   a3(i,2,k,1)=0._mytype
   enddo
   enddo 
...
!      if ((xkx(i)==0.).and.(zkz(k)==0)) then
if (nrank==0) then
   a3(1,1,1,3)=cmplx(1._mytype,1._mytype, kind=mytype)
   a3(1,1,1,4)=0._mytype
   a3(1,1,1,5)=0._mytype
endif
!      endif
!   enddo
!   enddo
